    ...
    <div className={styles.container}>
      <div>
        ...
        <p className={styles.parrafo}>
          ...
          granos de granos de café. A lo largo de los siglos, el café se propagó
          a través del comercio y la colonización, extendiéndose por el Medio
          Oriente, Europa y finalmente alcanzando América. A medida que el café
          se difundió, también se convirtió en un componente integral de
          diversas culturas. Se establecieron cafeterías en ciudades europeas en
          el siglo XVII, brindando espacios sociales para la discusión y el
          intercambio de ideas.En el siglo XVIII, el café se volvió central en
          el floreciente movimiento de la Ilustración, con intelectuales y
